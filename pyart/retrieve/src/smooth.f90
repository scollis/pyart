...
subroutine wind_cost_orig(dux, duy, duz, duxy, duxz, duyz, dvx, &
...
subroutine wind_grad_orig(dux, duy, duz, duxy, duxz, duyz, dvx, &
                          dvy, dvz, dvxy, dvxz, dvyz, wgt_s, &
...
subroutine wind_grad_potvin(dux, duy, duz, dvx, dvy, dvz, dwx, dwy, dwz, &
